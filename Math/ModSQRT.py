...
# source https://rosettacode.org/wiki/Tonelli-Shanks_algorithm#Python
...
if __name__ == '__main__':
    ttest = [(, )]
    for n, p in ttest:
        r = tonelli(n, p)
        assert (r * r - n) % p == 0
